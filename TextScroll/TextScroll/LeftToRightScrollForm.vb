...
Public Class LeftToRightScrollForm
    ...
    ' MainForm_Load - The event handler for when the form initally loads.
    Private Sub MainForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        TextLabel.Location = New System.Drawing.Point(0, 0)    ' Positions the text label in the center of the form vertically, while placing it on the left edge of the form.
